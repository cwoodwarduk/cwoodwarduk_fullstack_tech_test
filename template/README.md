...
> Due to issues with my work machine, I was not able to get the environment provided in your Docker containers up and running, 
> hence I requested to set up my own environment
> (it's worth noting my current workplace uses cloud-based environments in AWS, so virtualisation is not part of my daily workflow).
> This required a bit of exploration and debugging to get an environment working including rebuilds of mysql, php and apache.
> What I managed to get working I appreciate isn't the most optimal or secure implementation but, given time limitations
> and setup issues, a Laravel Valet environment was the only one I could get working after my own Docker and Homestead 
> implementations didn't work.
>
> In terms of design of the frontend app, although I have familiarity with SASS and its use cases, because of the component-based
> architecture of React, benefits of SASS such as nesting and mixins seemed less useful where component-based styling can be used -
> which I attempted to demonstrate on the chargeButton component with the limited time available.
>
> Had I had more time I would have further broken down the frontend into more granular components, added testing with JEST,
> implemented O2Auth in the API with Laravel Passport, and done more extensive unit testing (success-failure-malformed tests) 
> with PHPUnit.
