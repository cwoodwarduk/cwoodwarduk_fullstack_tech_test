...
# ---------------------------------------
EXISTING_CONTAINER=`docker ps -af name=car-charge-points-api -q`
...
EXISTING_CONTAINER=`docker ps -af name=car-charge-points-api-docs -q`
...
EXISTING_CONTAINER=`docker ps -af name=car-charge-points-front -q`
...
#  * Names the containers as "car-charge-points-api" & "car-charge-points-front"
...
# ---------------------------------------
# Api
docker run -d --name car-charge-points-api \
    -p 8000:80 \
    -w /var/www/html/ \
...
# Api Docs
docker run -d --name car-charge-points-api-docs \
    -p 8001:8080 \
...
# Front end
docker run -d --name car-charge-points-front \
    -p 8080:80 \
    -w /var/www/html/ \
